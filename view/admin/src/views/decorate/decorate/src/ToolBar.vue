...
const toolList = ref([
    ...
    { type: "imageAd", url: "mobile", label: "图片广告", content: '<i class="iconfont-admin icon-image_nav"></i>', module: {}, isShow: true },
...
const advancedList = ref([
    ...
    { type: "imageTextComponent", url: "mobilePro", label: "图文介绍", content: '<i class="iconfont-admin icon-image_text_component"></i>', module: {}, isShow: true },
    ...
    { type: "mixedProductDisplay", url: "mobilePro", label: "商品混排", content: '<i class="iconfont-admin icon-mixed_product_display"></i>', module: {}, isShow: true },
    ...
    { type: "comboSuggestions", url: "mobilePro", label: "组合推荐", content: '<i class="iconfont-admin icon-combo_suggestions"></i>', module: {}, isShow: true },
    { type: "slideLargeImage", url: "mobilePro", label: "大图滑动", content: '<i class="iconfont-admin icon-slide_large_image"></i>', module: {}, isShow: true },
...
const adminOtherList = ref([{ type: "seckill", url: "mobilePromotion", label: "秒杀", content: '<i class="iconfont-admin icon-seckill"></i>', module: {}, isShow: true }]);
const shopToolList = ref([{ type: "shopInfo", url: "mobilePromotion", label: "店铺信息", content: '<i class="iconfont-admin icon-product"></i>', module: {}, isShow: true }]);
const clone = (obj: any) => {

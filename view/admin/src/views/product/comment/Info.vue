            ...
            <div class="lyecs-form-table">
                <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
                    <el-form-item label="评论商品" prop="productIds">
                        <SelectProduct :isMultiple="false" v-if="!loading" v-model:ids="formState.productIds"> </SelectProduct>
                    </el-form-item>
                    ...
                    <el-form-item label="评论星级" prop="commentRank">
                        <el-radio-group v-model="formState.commentRank">
                    ...
                    <el-form-item :rules="[{ required: true, message: '评论内容不能为空!' }]" label="评论内容" prop="content">
                        <TigInput classType="tig-form-input" v-model="formState.content" type="textarea" />
                    </el-form-item>
                    ...
                    <el-form-item label="晒单" prop="showPics">
                        <FormAddGallery v-if="!loading" v-model:photos="formState.showPics" :isMultiple="true"> </FormAddGallery>
                    </el-form-item>
                    <el-form-item label="排序" prop="sortOrder">
                        <TigInput classType="tig-form-input" type="integer" v-model="formState.sortOrder" />
                    </el-form-item>
                    <el-form-item label="是否推荐" prop="isRecommend">
                        <el-radio-group v-model="formState.isRecommend">

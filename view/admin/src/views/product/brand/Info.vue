            ...
            <div class="lyecs-form-table">
                <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
                    <el-form-item :rules="[{ required: true, message: '品牌名称不能为空!' }]" label="品牌名称" prop="brandName">
                        <BusinessData v-model:modelValue="formState.brandName" placeholder="请输入品牌名称" :dataType="4" :dataId="id"></BusinessData>
                    </el-form-item>
                    <el-form-item label="品牌LOGO" prop="brandLogo">
                        <FormAddGallery v-model:photo="formState.brandLogo"></FormAddGallery>
                    ...
                    <el-form-item label="首字母" prop="firstWord">
                        <TigInput classType="tig-form-input" v-model="formState.firstWord"/>
                    ...
                    <el-form-item label="是否热门品牌" prop="brandIsHot">

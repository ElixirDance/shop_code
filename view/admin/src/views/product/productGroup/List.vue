...
import { batchSubmit, delProductGroup, getProductGroupList, updateProductGroupField } from "@/api/product/productGroup";

const config: any = useConfigStore();
// 基本参数定义
const filterState = ref<ProductGroupFilterState[]>([
    {
        productGroupName: "最新商品",
        productGroupSn: "",
...
// 多选操作
const onSelectChange = (e: ProductGroupFilterState[]) => {
    selectedIds.value = e.map((item) => item.productGroupId);
};
</script>

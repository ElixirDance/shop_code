            ...
            <div v-if="!loading" class="lyecs-form-table">
                <el-form ref="formRef" :model="formState" label-width="auto">
                    ...
                    <el-form-item label="上级分类" prop="parentId">
                        <SelectArticleCategory :min-width="'100%'" v-model="formState.parentId" :disabled="action == 'add' || parentId.length > 0"></SelectArticleCategory>
                    </el-form-item>
...
const onSubmit = async () => {
    ...
    // let parentId = '';
    // if(formState.value.parentId && formState.value.parentId.length > 0){

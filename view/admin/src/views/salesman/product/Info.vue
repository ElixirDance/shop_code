                        ...
                        <template v-for="(item, index) in tableConfig">
                            <el-table-column v-if="item.children && item.children.length" :label="item.label" :prop="item.label" align="center">
                                <template v-for="(child, index2) in item.children">
                                    <el-table-column width="130" align="center" :label="child.label" :prop="child.prop" v-if="saleType == 2 && child.prop == 'downSalesmanRate'">
                                    ...
                                    <el-table-column width="130" align="center" :label="child.label" :prop="child.prop" v-if="saleType <= 2 && child.prop == 'rate'">
                                        <template #default="{ row, $index }">
                                            <el-form-item :prop="child.prop">
                                                <TigInput
                                                    type="decimal"

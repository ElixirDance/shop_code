                ...
                <div v-if="!loading">
                                ...
                                <el-row>
                                    <el-col :span="8">
                                        <PopForm
                                            ...
                                            :max="10"
                                            :params="{ id: formState.userId, field: 'nickname' }"
                    ...
                    <div class="container-card">
                        <div class="title">
                            ...
                            <DialogForm :params="{ act: 'detail', id: formState.userId, type: 1 }" isDrawer path="user/user/EditAccount" title="资金管理" width="600px" @okCallback="onSubmit">
                                <a class="btn-link mr10">管理</a>
                            </DialogForm>
                            <DialogForm :params="{ act: 'detail', id: formState.userId, type: 1 }" isDrawer path="user/user/AccountLog" title="资金管理" width="资金明细" :showClose="false" :showOnOk="false">
                    ...
                    <div class="container-card">
                        <div class="title">
                            ...
                            <DialogForm :params="{ act: 'detail', id: formState.userId, type: 3 }" isDrawer path="user/user/EditAccount" title="资金管理" width="600px" @okCallback="onSubmit">
                                <a class="btn-link mr10">管理</a>
                            </DialogForm>
                            <DialogForm :params="{ act: 'detail', id: formState.userId, type: 3 }" isDrawer path="user/user/AccountLog" title="资金管理" width="资金明细" :showClose="false" :showOnOk="false">
                                <a class="btn-link">明细</a>
                            </DialogForm>
                        </div>
                        <div class="info-card">

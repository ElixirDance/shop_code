                        ...
                        >
                            ...
                            <el-table-column :width="100" fixed="right" label="操作">
                                <template #default="{ row }">
                                    ...
                                    <DeleteRecord :params="{ id: row.messageLogId }" :requestApi="delMessageLog" @afterDelete="loadFilter"
                                        >删除
                                    </DeleteRecord>
                                </template>
                            </el-table-column>
...
const filterParams = reactive<MessageLogFilterParams>({
    //初使化用于查询的参数
    page: 1,
...
const onSelectChange = (e: MessageLogFilterState[]) => {
    selectedIds.value = e.map((item) => item.messageLogId);
};
</script>

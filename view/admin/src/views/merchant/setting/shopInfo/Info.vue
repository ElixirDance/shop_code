<template>
    <el-form ref="formRef" :model="formState" class="form-body" label-suffix="：" label-width="auto">
        ...
        <el-form-item :rules="[{ required: true, message: '请输入店铺名称!' }]" label="店铺名称" prop="shopTitle">
            <TigInput classType="tig-form-input" v-model="formState.shopTitle" placeholder="请输入店铺名称" />
        ...
        <el-form-item label="店铺简介" prop="description">
            <TigInput classType="tig-form-input" v-model="formState.description" :rows="4" type="textarea" />
        </el-form-item>
    </el-form>
</template>

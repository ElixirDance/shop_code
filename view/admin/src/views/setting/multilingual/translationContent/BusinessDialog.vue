            ...
            <div class="lyecs-form-table">
                <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
                    <el-form-item prop="translationName" label="翻译原文：" :rules="[{ required: true, message: '翻译原文不能为空!' }]">
                        ...
                        <el-button type="primary" @click="_updateTranslation(formState.translationName)">一键生成翻译</el-button>
                    </el-form-item>
...
const onSubmit = async () => {
    ...
    try {
        ...
        const result = await updateCreateTranslation({ dataId: id.value, ...formState.value, items: filterateLocales(localesList.value) });

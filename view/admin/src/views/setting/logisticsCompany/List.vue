                ...
                <div class="table-container">
                    <a-spin :spinning="loading">
                        ...
                        >
                            ...
                            <el-table-column label="配送方式描述" prop="logisticsDesc">
                                <template #default="{ row }">
                                    <PopForm
                            ...
                            <el-table-column :width="150" fixed="right" label="操作">
                                <template #default="{ row }">
                                    ...
                                    <DeleteRecord :params="{ id: row.logisticsId }" :requestApi="delLogisticsCompany" @afterDelete="loadFilter"
                                        >删除
                                    </DeleteRecord>
                                </template>
                            </el-table-column>
...
const filterParams = reactive<LogisticsCompanyFilterParams>({
    //初始化用于查询的参数
    page: 1,
...
const onSelectChange = (e: LogisticsCompanyFilterState[]) => {
    selectedIds.value = e.map((item) => item.logisticsId);
};
</script>

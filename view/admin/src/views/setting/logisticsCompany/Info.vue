        ...
        <div class="content_wrapper">
            <div class="lyecs-form-table">
                <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
                    <el-form-item :rules="[{ required: true, message: '配送方式名称不能为空!' }]" label="配送方式名称" prop="logisticsName">
                        <TigInput classType="tig-form-input" v-model="formState.logisticsName"/>
                    </el-form-item>
                    <el-form-item :rules="[{ required: true, message: '配送公司代号不能为空!' }]" label="配送公司代号" prop="logisticsCode">
                        <TigInput classType="tig-form-input" v-model="formState.logisticsCode"/>
                    </el-form-item>
                    <el-form-item label="配送方式描述" prop="logisticsDesc">
                        <TigInput classType="tig-form-input" v-model="formState.logisticsDesc" :row="3" type="textarea"/>
                    </el-form-item>

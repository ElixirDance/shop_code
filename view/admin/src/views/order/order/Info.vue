    ...
    <div v-if="!loading">
        <div class="container-card" v-if="!isParent">
            ...
            <el-space :size="10" class="button-card">
                ...
                <el-button bg size="small" text type="primary" @click="openPage(`/admin/print/orderPrint?ids=${formState.orderId}`)"> 打印订单 </el-button>
                <el-button v-if="formState.wayBill" bg size="small" text type="primary" @click="openPage(`/admin/print/waybill?id=${formState.orderId}`)">
                    打印面单
                </el-button>
            </el-space>

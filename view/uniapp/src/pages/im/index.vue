            ...
            <view class="thanos-layout-main-content" @click="handleSetRead">
                <scroll-view class="message-scroll" :scroll-top="scrollTop" scroll-y="true" @scroll="handleScroll">
                    <view class="message-box">
                        <view class="empty-text" v-if="loadend">{{ $t("已经没有更多消息了") }}</view>
                        <template v-for="(item, index) in messageList" :key="item.id">
                            ...
                            >
                                <view class="message-time" v-if="item.messageType !== 'product' && item.messageType !== 'order'">
                                    <span>{{ item.sendTime }}</span>
                                </view>
                                <view class="message-time" v-if="item.type === 3">
                                        ...
                                        <template v-if="item.messageType">
                                            <view class="message-context">
                                                <view class="thanos-text-message">
                                                    ...
                                                    <view class="message-image" v-if="item.messageType === 'image'">
                                                        <tig-image :src="item.content.pic"></tig-image>
                                                    </view>
                                                    <view v-if="item.messageType === 'custom'">
                                                        <view class="custom-message-product" v-if="item.content.product">
                                                            <view class="product-img" @click="handleLink(`detail`, item)">
                                                                <tig-image v-if="item.content.product.picUrl" :src="item.content.product.picUrl"></tig-image>
                                                            </view>
                                                            <view class="product-info">
                                                                ...
                                                                <view class="product-price">
                                                                    <format-price
                                                                        ...
                                                                        :priceData="item.content.product.productPrice"
                                                                    ></format-price>
                                                                </view>
                                                            </view>
                                                        </view>
                                                        <view class="custom-message-order" v-if="item.content.order" @click="handleLink(`order`, item)">
                                                            <view class="tit">
                                                                {{ item.content.order.orderStatusName }}
                                                            </view>
                                                            <view class="info">
                                                                <view class="product-img">
                                                                    <tig-image v-if="item.content.order.picUrl" :src="item.content.order.picUrl"></tig-image>
                                                                </view>
                                                                <view class="product-info">
                                                                    <view class="product-name">
                                                                    ...
                                                                    <view class="product-txt">
                                                                        ...
                                                                        <format-price
                                                                            ...
                                                                            :priceData="item.content.order.totalAmount"
                                                                        ></format-price>
                                                                    </view>
                                                                </view>
                                                            </view>
                                ...
                                <view class="im-goods-card" v-if="item.messageType === 'product'">
                                    <view class="content">
                                        <view class="pic">
                ...
                <view class="wapim-inputer">
                    <view class="thanos-hairline--top-bottom wapim-main-inputer">
                        ...
                        <view class="wapim-inputer-operation">
                            <span class="operation face" @click="showEmojiHandle"></span>
                            <template v-if="hasTxt === true">
                                <span class="operation send" @click="sendTxt">{{ $t("发送") }}</span>
                            </template>
                            <template v-else>
                                <view class="operation plus" @click="showMoreHandle"></view>
                            </template>
                        </view>
                    </view>
                    <view class="wapim-inputer-plugin" v-show="moreHandle">
                        <view class="wapim-inputer-file-picker">
                            <view class="file-inputer-plugin">
                                <up-upload @afterRead="afterRead" name="6" multiple :maxCount="1">
                    ...
                    <view class="wapim-inputer-plugin" v-show="moreEmoji">
                        <view class="wapim-inputer-file-picker">
                            <view class="file-emoji-plugin">
                                <Emoji @insertEmoji="onInsertEmoji"></Emoji>
                            </view>
                        </view>
                    </view>
                </view>
...
const uploadFile = (filePath: any) => {
    uni.uploadFile({
        url: baseUrl + import.meta.env.VITE_API_PREFIX + "user/user/upload_img",

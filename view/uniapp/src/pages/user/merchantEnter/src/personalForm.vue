    ...
    <view>
        <template v-if="!props.id || !loadStatus">
                ...
                <view class="form-box">
                    <up-form labelPosition="left" :model="firstForm" :rules="firstFormRules" ref="firstFormRef" labelWidth="100" errorType="toast">
                        ...
                        <up-form-item :required="true" :label="$t('居住地址') + '：'" prop="residentialAddress">
                            <up-input inputAlign="right" v-model="firstForm.residentialAddress" :placeholder="$t('请输入居住地址')" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :required="true" :label="$t('性别') + '：'" prop="sex">
                            <view class="sex-box">
                                <up-radio-group style="width: 485rpx; justify-content: end" v-model="firstForm.sex" placement="row">
                                    <up-radio style="padding-right: 15rpx" activeColor="var(--general)" shape="circle" :name="1" :label="$t('男')"></up-radio>
            ...
            <template v-if="currentStep == 2">
                <up-form labelPosition="left" :model="secondForm" :rules="secondFormRules" ref="secondFormRef" labelWidth="100" errorType="toast">
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item prop="shopData.shopLogo" class="special-item" labelPosition="top" :label="$t('店铺logo') + '：'">
                            <view class="upload-box">
            ...
            <template v-if="currentStep === 3">
                ...
                <up-form labelPosition="left" labelWidth="100">
                    <view class="form-box">
                        <view class="form-title">{{ $t("联系人信息") }}</view>
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item :label="$t('详细地址') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.merchantData.detailedAddress"
                                border="none"
                            ></up-input>
                    ...
                    <view class="form-box">
                        ...
                        <template v-if="formData.baseData.supplementaryInformation.length > 0">
                            <up-form-item :label="$t('补充信息') + '：'" labelPosition="top">

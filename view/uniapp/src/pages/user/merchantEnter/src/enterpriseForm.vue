<template>
    <view>
        <template v-if="!props.id || !loadStatus">
            <steps :currentStep="currentStep - 1" :stepList="stepList"></steps>
            <template v-if="currentStep == 1 || currentStep == 2">
                <view class="form-box">
                    <up-form labelPosition="left" :model="firstForm" :rules="firstFormRules" ref="firstFormRef" labelWidth="100" errorType="toast">
                        <template v-if="currentStep == 1">
                            <up-form-item :label="$t('主体类型') + '：'">
                                <view class="type-text">企业</view>
                            </up-form-item>
                            <up-form-item :required="true" :label="$t('企业名称') + '：'" prop="companyName">
                                <up-input inputAlign="right" v-model="firstForm.companyName" :placeholder="$t('请输入企业名称')" border="none"></up-input>
                            </up-form-item>
                            ...
                            <up-form-item :required="true" :label="$t('详细地址') + '：'" prop="businessLicenseAddress">
                                <up-input
                                    inputAlign="right"
                                    v-model="firstForm.businessLicenseAddress"
                                    :placeholder="$t('请输入详细地址')"
                                    border="none"
                                ></up-input>
                            </up-form-item>
                            <up-form-item :required="true" :label="$t('经营范围') + '：'" prop="businessScope" class="textarea">
                                <up-textarea inputAlign="right" height="48" v-model="firstForm.businessScope" :placeholder="$t('请输入经营范围')" border="none"></up-textarea>
                            </up-form-item>
                            <up-form-item :required="true" :label="$t('社会信用代码') + '：'" prop="businessLicenseId">
                                <up-input
                                    inputAlign="right"
                                    v-model="firstForm.businessLicenseId"
                                    :placeholder="$t('请输入统一社会信用代码')"
                                    border="none"
                                ></up-input>
                            </up-form-item>
                            <up-form-item :required="true" class="special-item" labelPosition="top" prop="operatingTermType" :label="$t('营业期限') + '：'">
                                <view>
                                    <view class="certificate-validity-item">
                                        <up-radio-group v-model="firstForm.operatingTermType" placement="column" @change="getValidity">
                                            <up-radio activeColor="var(--general)" shape="circle" :name="1" :label="$t('区间有效')"></up-radio>
                                        </up-radio-group>
                                    ...
                                    <view class="certificate-validity-item">
                                        <up-radio-group v-model="firstForm.operatingTermType" placement="column" @change="getValidity">
                                            <up-radio activeColor="var(--general)" shape="circle" :name="2" :label="$t('长期有效')"></up-radio>
                                        </up-radio-group>
                        ...
                        <template v-if="currentStep == 2">
                            <up-form-item :required="true" :label="$t('姓名') + '：'" prop="corporateName">
                                <up-input inputAlign="right" v-model="firstForm.corporateName" :placeholder="$t('请输入姓名')" border="none"></up-input>
                            </up-form-item>
                            <up-form-item :required="true" :label="$t('居住地址') + '：'" prop="residentialAddress">
                                <up-input
                                    inputAlign="right"
                                    v-model="firstForm.residentialAddress"
                            ...
                            <up-form-item :required="true" :label="$t('性别') + '：'" prop="sex">
                                <view class="sex-box">
                                    <up-radio-group style="width: 485rpx; justify-content: end" v-model="firstForm.sex" placement="row">
                                        <up-radio
                            ...
                            <up-form-item :required="true" :label="$t('出生日期') + '：'" prop="birthday">
                                <uni-datetime-picker type="date" :clear-icon="false" v-model="firstForm.birthday" />
                            </up-form-item>
                            ...
                            <up-form-item :required="true" :label="$t('证件号码') + '：'" prop="documentNumber">
                                <up-input inputAlign="right" v-model="firstForm.documentNumber" :placeholder="$t('请输入证件号码')" border="none"></up-input>
                            </up-form-item>
                            ...
                            <up-form-item :required="true" prop="frontOfPhoto" class="special-item" labelPosition="top" :label="$t('证件照正面') + '：'">
                                <view class="upload-box">
                                    <upload v-model="firstForm.frontOfPhoto" :isValueArray="true"></upload>
                                </view>
                            </up-form-item>
                            <up-form-item :required="true" prop="backOfPhoto" class="special-item" labelPosition="top" :label="$t('证件照反面') + ':'">
                                <view class="upload-box">
                                    <upload v-model="firstForm.backOfPhoto" :isValueArray="true"></upload>
                                </view>
                            </up-form-item>
                        </template>
                    </up-form>
            ...
            <template v-if="currentStep == 3">
                <up-form labelPosition="left" :model="secondForm" :rules="secondFormRules" ref="secondFormRef" labelWidth="100" errorType="toast">
                    <view class="form-box">
                        ...
                        <up-form-item :required="true" :label="$t('联系人姓名') + '：'" prop="merchantData.contactName">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.contactName"
                                :placeholder="$t('请输入姓名')"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        <up-form-item :required="true" :label="$t('联系人手机') + '：'" prop="merchantData.contactPhone">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.contactPhone"
                        ...
                        <up-form-item :required="true" :label="$t('常用邮箱') + '：'" prop="merchantData.contactEmail">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.contactEmail"
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item :required="true" :label="$t('开户银行') + '：'" prop="merchantData.bankDeposit">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.bankDeposit"
                        ...
                        <up-form-item :required="true" :label="$t('开户支行') + '：'" prop="merchantData.bankBranch">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.bankBranch"
                        ...
                        <up-form-item :required="true" :label="$t('对公银行账户')" prop="merchantData.bankCard">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.bankCard"
                                :placeholder="$t('请输入对公银行账户')"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        <up-form-item
                        ...
                        >
                            <view class="upload-box">
                                <upload v-model="secondForm.merchantData.accountOpeningPermit" :limit="3"></upload>
                            </view>
                        </up-form-item>
                    </view>
                    <view class="form-box">
                        ...
                        <up-form-item :required="true" :label="$t('商户名称') + '：'" prop="merchantData.merchantName">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.merchantName"
                        ...
                        <up-form-item :required="true" :label="$t('经营地址') + '：'" @click="handleShowSelectRegion" prop="merchantData.businessAddress">
                            <up-input
                                inputAlign="right"
                                disabled
                                disabledColor="#ffffff"
                        ...
                        <up-form-item :required="true" :label="$t('详细地址') + '：'" prop="merchantData.detailedAddress">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.merchantData.detailedAddress"
                                :placeholder="$t('请输入详细地址')"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        ...
                        >
                            <view class="upload-box">
                                <upload v-model="secondForm.merchantData.businessLicenseImg" :isValueArray="true"></upload>
                            </view>
                        </up-form-item>
                    </view>
                    <view class="form-box">
                        ...
                        <up-form-item :required="true" :label="$t('店铺名称') + '：'" prop="shopData.shopTitle">
                            <up-input inputAlign="right" v-model="secondForm.shopData.shopTitle" :placeholder="$t('请输入店铺名称')" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :required="true" :label="$t('联系电话') + '：'" prop="shopData.contactMobile">
                            <up-input
                                inputAlign="right"
                                v-model="secondForm.shopData.contactMobile"
                                :placeholder="$t('请输入客服电话')"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :required="true" prop="shopData.shopLogo" class="special-item" labelPosition="top" :label="$t('店铺logo') + '：'">
                            <view class="upload-box">
                                <upload :limit="3" v-model="secondForm.shopData.shopLogo"></upload>
                            </view>
                        </up-form-item>
                        <up-form-item class="special-item" labelPosition="top" :label="$t('补充信息') + '：'">
                            <view class="upload-box">
                                <upload :limit="3" v-model="firstForm.supplementaryInformation"></upload>
                            </view>
                        </up-form-item>
                    </view>
                </up-form>
            ...
            <template v-if="currentStep === 4">
                ...
                <up-form labelPosition="left" labelWidth="115">
                    <view class="form-box">
                        <view class="form-title">{{ $t("联系人信息") }}</view>
                        <up-form-item :label="$t('联系人姓名') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.merchantData.contactName"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('手机号') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.merchantData.contactPhone"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('常用邮箱') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.merchantData.contactEmail"
                                border="none"
                            ></up-input>
                        </up-form-item>
                    </view>
                    <view class="form-box">
                        ...
                        <up-form-item :label="$t('对公账户') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.baseData.companyName" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('开户银行') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.merchantData.bankDeposit"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('开户支行') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.merchantData.bankBranch" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('对公银行账户') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.merchantData.bankCard" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('开户许可证') + '：'" labelPosition="top" v-if="formData.merchantData.accountOpeningPermit.length > 0">
                            <template v-for="(item, index) in formData.merchantData.accountOpeningPermit" :key="index">
                                <tig-image class="image-box" :src="item.picUrl"></tig-image>
                            </template>
                        </up-form-item>
                    </view>
                    <view class="form-box">
                        ...
                        <up-form-item :label="$t('商户名称') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.merchantData.merchantName"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :label="$t('营业执照') + '：'" labelPosition="top" v-if="formData.merchantData.businessLicenseImg.length > 0">
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item :label="$t('店铺名称') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.shopData.shopTitle" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('联系电话') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.shopData.contactMobile" border="none"></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :label="$t('店铺logo') + '：'" labelPosition="top" v-if="formData.shopData.shopLogo.length > 0">
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item :label="$t('社会信用代码') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formData.baseData.businessLicenseId"
                                border="none"
                            ></up-input>
                        </up-form-item>
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item :label="$t('个人姓名') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.baseData.corporateName" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('证件类型') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="documentTypeText" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('证件号码') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formData.baseData.documentNumber" border="none"></up-input>
                        </up-form-item>
                        <up-form-item :label="$t('证件有效期') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="certificateValidityPeriodText" border="none"></up-input>
                        </up-form-item>
                    ...
                    <view class="form-box">
                        ...
                        <up-form-item class="noflex" :label="$t('证件照正面') + '：'" labelPosition="top">
                            <image class="image-box" :src="staticResource('common/lock@3x.png')"></image>
                            <view style="padding-top: 10rpx; width: 100%">
                                <up-alert showIcon type="info" :description="$t('为了保护个人隐私信息不泄露，该照片不予展示')"></up-alert>
                            </view>
                        </up-form-item>
                        <up-form-item class="noflex" :label="$t('证件照反面') + '：'" labelPosition="top">
                            <image class="image-box" :src="staticResource('common/lock@3x.png')"></image>
                            <view style="padding-top: 10rpx; width: 100%">
                                <up-alert showIcon type="info" :description="$t('为了保护个人隐私信息不泄露，该照片不予展示')"></up-alert>
                            </view>
                        </up-form-item>
                        <up-form-item :label="$t('补充信息') + '：'" labelPosition="top" v-if="formData.baseData.supplementaryInformation.length > 0">
            ...
            <template v-if="currentStep == 5">
                <success :initialUserInfo="formData.initialUserInfo"></success>
            </template>
        ...
        <!-- secondForm -->
        <selectRegion v-model:show="showSelectRegion" v-model="secondForm.merchantData.businessAddress" @sendRegionNames="getRegionNames"></selectRegion>
        <selectRegion v-model:show="showRegisteredAddress" v-model="firstForm.licenseAddrProvince" @sendRegionNames="getregisteredAddress"></selectRegion>
    </view>
</template>

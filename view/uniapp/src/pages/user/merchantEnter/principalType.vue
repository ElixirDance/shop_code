    ...
    <view class="container">
        <template v-if="loaded">
            <tig-layout>
                ...
                <view class="type-box" :class="{ active: type === 1 }" @click="type = 1"> <text class="iconfont-h5 icon-geren icon-size"></text> 个人 </view>
                <view class="type-box" :class="{ active: type === 2 }" @click="type = 2"><text class="iconfont-h5 icon-qiye icon-size"></text> 企业 </view>

                <tig-fixed-placeholder :border="false" backgroundColor="#fff">
                    <view class="btn-box">

            ...
            <view class="after-sale-form">
                <uni-forms ref="formRef" :modelValue="form" label-width="170rpx">
                    <uni-forms-item :label="$t('退款方式')" name="aftersaleType">
                        <picker style="height: 100%" @change="getAftersaleType" :value="aftersaleTypeIndex" range-key="label" :range="aftersaleTypeList">
                            <view class="form-item-content">
                                <view>
                                    <text class="form-item-value" v-if="aftersaleTypeIndex !== null">{{ aftersaleTypeList[aftersaleTypeIndex!].label }}</text>
                                    <text class="form-item-text" v-else>{{ $t("请选择") }}</text>
                                </view>
                    ...
                    <uni-forms-item :label="$t('退款原因')" name="aftersaleReason">
                        <picker @change="getAftersaleReason" :value="aftersaleReasonIndex" :range="aftersaleReasonList">
                            <view class="form-item-content">
                                <view>
                                    <text class="form-item-value" v-if="form.aftersaleReason">{{ form.aftersaleReason }}</text>
                                    <text class="form-item-text" v-else>{{ $t("请选择") }}</text>
                                </view>
                                <view class="form-item-icon">
                                    <uni-icons type="arrowright" size="16" color="#999"></uni-icons>
                    ...
                    <uni-forms-item :label="$t('上传凭证')" name="description">
                        <view class="upload-box">
                            ...
                            <upload v-model="fileLists" :limit="5" :isValueArray="true"></upload>
                        </view>
                    </uni-forms-item>
                </uni-forms>
            </view>

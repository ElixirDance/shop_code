            ...
            <template v-if="Object.keys(infoData).length">
                <template v-if="showReturngoodstip">
                    <view class="returngoodstip-box">
                        <view class="returngoodstip-bg"></view>
                        <view class="returngoodstip-content">
                            <view class="iconfont-h5 icon-tongzhi"> </view>
                            <view class="returngoodstip-text line1">{{ infoData.returnGoodsTip }}</view>
                            <view class="iconfont-h5 icon-chacha" @click="showTip = false"> </view>
                        </view>
                    </view>
                </template>
                        ...
                        <template v-if="Number(infoData.refundAmount) > 0">
                            <view class="refund-info-item">
                                ...
                                <view class="value price"
                                    ><format-price :showText="false" :isBottom="false" :priceData="infoData.refundAmount"></format-price
                                ></view>
                            </view>
                        </template>
                        ...
                        <view class="after-sale">
                            <template v-if="infoData.refund.onlineBalance > 0">
                                <view class="after-sale-item">
                                    ...
                                    <view class="value"
                                        ><format-price :showText="false" :isBottom="false" :priceData="infoData.refund.onlineBalance"></format-price
                                    ></view>
                            ...
                            <template v-if="infoData.refund.offlineBalance > 0">
                                <view class="after-sale-item">
                                    ...
                                    <view class="value"
                                        ><format-price :showText="false" :isBottom="false" :priceData="infoData.refund.offlineBalance"></format-price
                                    ></view>
                                    <view class="after-sale-status">{{ infoData.refund.isOnline === 2 ? $t("退款成功") : $t("退款中") }}</view>
                                </view>
                            </template>
                            <template v-if="infoData.refund.refundBalance > 0">
                                <view class="after-sale-item">
                                    ...
                                    <view class="value"
                                        ><format-price :showText="false" :isBottom="false" :priceData="infoData.refund.refundBalance"></format-price
                                    ></view>
                                    <view class="after-sale-status">{{ infoData.refund.isOnline === 2 ? $t("退款成功") : $t("退款中") }}</view>
                                </view>
                            </template>

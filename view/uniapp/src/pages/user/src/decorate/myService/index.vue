                    ...
                    <block v-for="(item, index) in list" :key="index">
                        <view class="service-item" @click="handleClick(item)">
                            <view class="service-icon">
                                <tig-image lazy-load :src="staticResource(item.picUrl)"></tig-image>
                            </view>
                            <view class="service-label">
                                {{ $t(item.picTitle ?? "") }}
                                <view class="service-arrow iconfont-h5 icon-youjiantou" v-if="menuType === 1"></view>
                            </view>
                        </view>
                    </block>
                </view>

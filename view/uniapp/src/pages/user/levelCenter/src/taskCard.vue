<template>
    <view class="task_container">
        ...
        <view class="task_list">
            <view class="task_item" v-if="taskData?.evpi === 1">
                <view class="img" :style="`background-image: url(${staticResource('user/evpi.png')});`"></view>
            ...
            <view class="task_item" v-if="taskData?.bindPhone === 1">
                <view class="img" :style="`background-image: url(${staticResource('user/bind_phone.png')});`"></view>
                <view class="task_info">
            ...
            <view class="task_item" v-if="taskData?.buyGoods === 1">
                <view class="img" :style="`background-image: url(${staticResource('user/buy_goods.png')});`"></view>
                <view class="task_info">
            ...
            <view class="task_item" v-if="taskData?.buyOrder === 1">
                <view class="img" :style="`background-image: url(${staticResource('user/buy_order.png')});`"></view>
                <view class="task_info">

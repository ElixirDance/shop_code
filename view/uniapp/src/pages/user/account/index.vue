<template>
    <tig-layout title="资金管理">
        ...
        <view v-show="activeTab === 'detail'">
            <detail v-model:active-tab="activeTab"></detail>
        </view>

        <view v-show="activeTab === 'log'">
            <log v-model:active-tab="activeTab"></log>
        </view>

        <block v-if="activeTab === 'deposit'">
            <deposit @back-detail="backDetail"></deposit>
        </block>

        <block v-if="activeTab === 'raplytocard'">
            <raplyToCard :balance="formState.balance" @backDetail="backDetail"></raplyToCard>
        </block>
    </tig-layout>
</template>

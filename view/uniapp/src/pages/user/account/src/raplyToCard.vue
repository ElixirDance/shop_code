    ...
    <view class="reply-main">
        <view class="reply-content">
            <up-form ref="formRef" :model="formState" label-width="170rpx" errorType="toast">
                ...
                <up-form-item :label="$t('银行详情')" prop="accountData.bankName" v-if="formState.accountData.accountType === 1">
                    <up-textarea v-model="formState.accountData.bankName" :placeholder="$t('请选择银行卡账号')" disabled fontSize="12" />
                </up-form-item>
                <up-form-item :label="$t('提现金额')" prop="amount">
                    <up-input type="number" v-model="formState.amount" :placeholder="$t('请输入提现金额')" clearable fontSize="12" />
                </up-form-item>
            </up-form>
        </view>
    </view>

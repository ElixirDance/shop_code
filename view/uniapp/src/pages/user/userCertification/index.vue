    ...
    <tig-layout title="实名认证">
        ...
        <block v-if="!loadStatus">
            <block v-if="formState.status == 0">
                <view class="form-box">
                    <up-form labelPosition="left" :model="formState" :rules="formStateRules" ref="formStateRef" labelWidth="100" errorType="toast">
                        <up-form-item :required="true" :label="$t('主体类型') + '：'" prop="type">
                            <view class="sex-box">
                                <up-radio-group style="width: 485rpx; justify-content: end" v-model="formState.type" placement="row">
                                    <up-radio
                                        ...
                                        :label="$t('个人')"
                                    ></up-radio>
                                    <up-radio activeColor="var(--general)" shape="circle" :name="2" :label="$t('企业')"></up-radio>
                                </up-radio-group>
                            </view>
                        </up-form-item>
                        <up-form-item v-if="formState.type == 1" :required="true" :label="$t('姓名') + '：'" prop="companyData.corporateName">
                            <up-input inputAlign="right" v-model="formState.companyData.corporateName" :placeholder="$t('请输入姓名')" border="none"></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :required="true" :label="$t('联系人手机') + '：'" prop="companyData.contactPhone">
                            <up-input
                                inputAlign="right"
                                v-model="formState.companyData.contactPhone"
                        ...
                        <up-form-item :required="true" :label="$t('出生日期') + '：'" prop="companyData.birthday">
                            <uni-datetime-picker type="date" :clear-icon="false" v-model="formState.companyData.birthday" />
                        </up-form-item>
                        ...
                        <up-form-item :required="true" :label="$t('证件号码') + '：'" prop="companyData.documentNumber">
                            <up-input
                                inputAlign="right"
                                v-model="formState.companyData.documentNumber"
                        ...
                        >
                            <view class="upload-box">
                                <upload v-model="formState.companyData.frontOfPhoto" :isValueArray="true"></upload>
                            </view>
                        </up-form-item>
                        <up-form-item :required="true" prop="companyData.backOfPhoto" class="special-item" labelPosition="top" :label="$t('证件照反面') + ':'">
                            <view class="upload-box">
                                <upload v-model="formState.companyData.backOfPhoto" :isValueArray="true"></upload>
                            </view>
                        </up-form-item>
                        <block v-if="formState.type == 2">
                            <up-form-item :required="true" :label="$t('企业名称') + '：'" prop="companyData.companyName">
                                <up-input
                                    inputAlign="right"
                                    v-model="formState.companyData.companyName"
                            ...
                            >
                                <view class="upload-box">
                                    <upload v-model="formState.companyData.businessLicenseImg" :isValueArray="true"></upload>
                                </view>
                            </up-form-item>
                        </block>
                    </up-form>
            ...
            <block v-if="formState.status != 0">
                ...
                <up-form labelPosition="left" labelWidth="100">
                    <view class="form-box">
                        ...
                        <up-form-item :label="formState.type == 1 ? $t('个人姓名') + '：' : $t('法人姓名') + '：'">
                            <up-input
                                ...
                                disabled
                                disabledColor="#ffffff"
                                v-model="formState.companyData.corporateName"
                                border="none"
                            ></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :label="$t('出生日期') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formState.companyData.birthday" border="none"></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :label="$t('手机号') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formState.companyData.contactPhone" border="none"></up-input>
                        </up-form-item>
                    ...
                    <view class="form-box" v-if="formState.type == 2">
                        <view class="form-title">{{ $t("企业信息") }}</view>
                        <up-form-item :label="$t('企业名称') + '：'">
                            <up-input inputAlign="right" disabled disabledColor="#ffffff" v-model="formState.companyData.companyName" border="none"></up-input>
                        </up-form-item>
                        ...
                        <up-form-item :label="$t('营业执照') + '：'" labelPosition="top" v-if="formState.companyData.businessLicenseImg.length > 0">
        ...
        <selectRegion
            v-model:show="showRegisteredAddress"
            v-model="formState.companyData.licenseAddrProvince"
            @sendRegionNames="getregisteredAddress"
        ></selectRegion>

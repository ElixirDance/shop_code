<template>
    <view>
        <tig-layout>
            <tig-navbar :title="navbarTitle"> </tig-navbar>
            ...
            <template v-if="order">
                <view class="order-pay-warp">
                    <view class="order_infos">
                        <view class="order_amount">
                            <template v-if="typeText !== 'recharge'">
                                <format-price :isBootom="false" :priceData="order.unpaidAmount"></format-price>
                            </template>
                            <template v-else>
                                <format-price :isBootom="false" :priceData="order.amount"></format-price>
                            </template>
                        </view>
                        <template v-if="typeText !== 'recharge'">
                            <view class="order_sn">
                    ...
                    <template v-if="order.payTypeId === 3">
                        <offline :offlinePaymentList="offlinePaymentList"></offline>
                    </template>

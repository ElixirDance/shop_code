<template>
    <view class="item">
        <input
            ...
            :value="fristPassword"
        />
        <view @click="passwordTypeChange(0)" :class="'password_show_hide iconfont ' + (passwordType[0] == 'text' ? 'icon-xianshi' : 'icon-yincang')"></view>
    </view>
    <view class="item">
        <input
            :type="passwordType[1]"
        ...
        />
        <view @click="passwordTypeChange(1)" :class="'password_show_hide iconfont ' + (passwordType[1] == 'text' ? 'icon-xianshi' : 'icon-yincang')"></view>
    </view>
    <view class="btn2-css3">
        <tig-button :loadingText="$t('确 认')" :loading="isLoading" @click="handleResetPassword" :disabled="isDisabled">
            {{ $t("确 认") }}
        </tig-button>
    </view>

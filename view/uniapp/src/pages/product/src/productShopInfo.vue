<template>
    <view class="shop-info-box">
        ...
        <view class="shop-info-btn">
            <view class="shop-info-btn-item" @click="handleShopCollection">{{ $t(collectText) }}</view>
            <view class="shop-info-btn-item" @click="handleToShop"><text class="iconfont icon-dianpu"></text> {{ $t("进店逛逛") }}</view>
        </view>
    </view>
</template>

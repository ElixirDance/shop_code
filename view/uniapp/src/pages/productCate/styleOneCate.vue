<template>
    <view>
        <tig-layout>
            <tig-navbar :showLeft="false" title="产品分类"></tig-navbar>
                                    ...
                                    <view class="listw">
                                        ...
                                        <view class="list acea-row">
                                            <block v-for="(hot, index) in hotCat" :key="index">
                                                ...
                                                >
                                                    <view class="picture">
                                                        <tig-image :src="hot.categoryPic" mode="aspectFill"></tig-image>
                                                    </view>
                                            ...
                                            <block v-for="(childCatItem, index1) in cat.children" :key="index1">
                                                ...
                                                >
                                                    <view class="picture" v-if="childCatItem.categoryPic">
                                                        <tig-image :src="childCatItem.categoryPic"></tig-image>
                                                    </view>

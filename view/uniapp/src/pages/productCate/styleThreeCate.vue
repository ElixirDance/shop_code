<template>
    <view>
        <tig-navbar title="产品分类" :showLeft="false"></tig-navbar>
        <search :needMenu="true" @menu="handleMenu" @search="handleSearch"></search>
        <view class="scroll-box">
            <view class="content-box">
                <view class="side">
                    <menuBox v-model:currentCateId="currentCateId" @change="reset"></menuBox>
                </view>
                <view class="list-box">
                    <selectCate
                        type="main"
                        ...
                        v-model:subCurrentCateId="subCurrentCateId"
                        ...
                        <template v-if="!isLoading && total > 0">
                            <scroll-view :scroll-y="true" class="list-scroll" @scrolltolower="reachBottom">
                                <view class="product-list">
                                    <view class="product-item" v-for="item in list" :key="item.productId">
                                        <view class="item-left" @click="handleToDetail(item.productId!)">
                                            <tig-lazy-image :src="item.picThumb"></tig-lazy-image>
        ...
        <specification ref="specificationRef" v-model="productId" @addCardSucceed="" @loadEnd="loadEnd" @close="handleClose"></specification>
    </view>
</template>

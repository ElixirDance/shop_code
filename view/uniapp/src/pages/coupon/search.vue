<template>
    <view class="coupon-search">
        <up-search @search="handleCustom" shape="square" v-model="keyword" :actionText="$t('取消')" @custom="handleCustom"></up-search>
        <view class="search_init_box" v-if="searchHistory.length">

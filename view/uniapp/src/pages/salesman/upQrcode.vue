    ...
    <tig-layout>
        <view class="qrcode-wrap">
            ...
            <template v-if="personalData.avatar">
                <view class="preview">
                    <view class="preview__overlay" :class="{ preview__overlay_loading: loading === true }" v-show="loading === true">二维码加载中...</view>
                    <view class="preview__overlay">
                        <tig-image :src="personalData.avatar" class="van-image__img"></tig-image>
                    </view>
            ...
            <template v-else>
                <view class="preview">
                    <view class="preview__overlay" v-show="loading === true">二维码加载中...</view>
                    <view class="van-image" style="width: 560rpx; height: 688rpx">
                        <!-- <img :src="defaultQrcode" class="van-image__img"> -->
                    </view>
                </view>
            ...
            <tig-fixed-placeholder backgroundColor="#fff">
                <tig-upload @change="onUpload" requestUrl="user/user/uploadImg">
                    <view class="btn-box">

<template>
    <tig-popup v-model:show="show" :zIndex="999" :showClose="false" backgroundColor="#fff" position="center">
        <view class="qrcode-box" @longpress.stop="handleSave">
            <image :src="qrcodePath" :margin="20" mode="aspectFit" style="width: 245px; height: 245px"></image>

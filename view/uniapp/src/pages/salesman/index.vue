            ...
            <view class="user-panel-block">
                <view class="user-info" @click="goPages('/pages/salesman/personalInfo')">
                    ...
                    <view class="user-info__content">
                        <view class="user-info__title">{{ member.nickname }}</view>
                ...
                <view class="level-panel" @click="goPages('/pages/salesman/level')" v-if="salesmanData.level && salesmanData.salesmanConfig.level.length > 1">
                    ...
                    <view class="van-ellipsis">
                        ...
                        <view class="level-panel__desc van-ellipsis">{{ levelTxt }}</view>
                    </view>
                </view>
            </view>
            <view class="data-panel-block">
                <view class="main-data-panel van-grid">
                    ...
                    <view class="main-data-panel-item van-grid-item">
                        <view class="van-grid-item__content">
                            ...
                            <view class="main-data-panel-item__content"
                                ><format-price :showText="false" :currencyFormat="false" :priceData="salesmanData.order?.todaySum"></format-price
                                >{{ $t("元") }}</view
                            >
                        </view>
                    </view>
                    <view class="main-data-panel-item van-grid-item">
                        <view class="van-grid-item__content">
                            ...
                            <view class="main-data-panel-item__content"
                                ><format-price :showText="false" :currencyFormat="false" :priceData="salesmanData.order?.allSum"></format-price
                                >{{ $t("元") }}</view
                            >
                            <view class="main-data-panel-item__desc main-data-panel-item__extra"
                                >{{ $t("含待结算")
                                }}<format-price :showText="false" :currencyFormat="false" :priceData="salesmanData.order?.waitCpsSum"></format-price
                                >{{ $t("元") }}
                ...
                <view class="cash-block" @click="goPages('/pages/user/account/index')">
                    <view role="button" tabindex="0" class="van-cell van-cell--clickable">
                        ...
                        <up-icon name="arrow-right" color="#c8c9cc" size="12"></up-icon>
                    </view>
                    <view class="asset-icon" @click.stop="showTipClick">
                        <up-icon name="question-circle" color="#969799" size="14"></up-icon>
                        <up-toast ref="uToastRef"></up-toast>
                    </view>
                </view>
                <view class="accordion__action-bar" @click="showClick">
                    <view v-if="showDataDetail === false">{{ $t("展开更多") }}</view>
                    <up-icon v-if="showDataDetail === false" name="arrow-down" color="#969799" size="14"></up-icon>
                    <up-icon v-else name="arrow-up" color="#969799" size="14"></up-icon>
                </view>
            </view>

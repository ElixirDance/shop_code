        ...
        <view class="withdraw__wrapper">
            ...
            <view class="withdraw-amount">
                ...
                <view class="withdraw-amount__main">
                    ...
                    <up-input type="number" placeholder="" border="none" clearable fontSize="36px" v-model="withdrawAmount" @change="amountChange"></up-input>
                </view>
                ...
                <block v-else>
                    <view class="withdraw-amount__footer">
                        <up-icon name="info-circle" color="#44bb00" size="14"></up-icon>

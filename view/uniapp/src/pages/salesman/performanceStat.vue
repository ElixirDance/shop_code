<template>
    ...
    <tig-layout >
        ...
        <up-action-sheet :show="showActionSheet" @close="showActionSheet = false" title="业绩指标说明" :round="10">
            <view class="explaination">
                <view class="explaination__item van-cell" v-for="perItem in performanceDescList" :key="perItem.perid">

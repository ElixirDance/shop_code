<template>
    <view class="areacode-box" @click="handleClick" :style="boxStyle">
        ...
        <up-picker @cancel="show = false" :show="show" :columns="[list]" keyName="labelName" @confirm="handleConfirm"></up-picker>
    </view>
</template>

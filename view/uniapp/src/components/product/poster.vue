<template>
    <view>
        ...
        <tig-popup v-model:show="show" @close="$emit('update:modelValue', false)" backgroundColor="transparent" position="center" :showClose="false">
...
const generatePoster = async () => {
    ...
    context.fillText(`${props.productInfo.productPrice}`, 20, 366 * powerw.value);

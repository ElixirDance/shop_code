<template>
    <view class="verifyslide">
        <view class="verify-img-out" :style="{ height: parseInt(imgSize.height) + 'px' }">
            ...
            >
                <image v-if="backImgBase" :src="'data:image/png;base64,' + backImgBase" class="img"></image>

                <view v-if="backImgBase" class="verify-refresh" @click="refresh" v-show="showRefresh"><i class="iconfont-pc icon-refresh"></i></view>
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <image v-if="blockBackImgBase" :src="'data:image/png;base64,' + blockBackImgBase" class="img"></image>
                    </view>
                </view>
            </view>
        </view>

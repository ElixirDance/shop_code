                    ...
                    <view class="item-content">
                        <div>
                            <image
                                class="catnav-logo"
                                mode="aspectFit"
                                :style="logoFormat.logoHeight"
                                :src="imageFormat(logoFormat.logoPic?.picUrl || '')"
                            />
                            <view class="search-lang-box">
                                <view class="default-search" @click="handleSkip" :style="searchFormat['padding-right'] + searchFormat['padding-left']">
                                    <view
                                        class="default-search-config catnav-search"
                                        :style="searchFormat['itemBackgroundColor'] + searchFormat['itemRadius']"
                                    >
                                ...
                                <block v-if="isOverseas()">
                                    <tig-select-lang></tig-select-lang>
                                </block>
                            </view>
                        </div>
                        ...
                        <scroll-view class="item-cat_nav-con" :scroll-left="catnavStore.navLeft" :scroll-with-animation="true" :scroll-x="true">
                            <view class="cat-nav-list">
                                <view :class="'nav-item ' + (catnavStore.currentCatnavId == 0 ? 'current' : '')" data-id="0">
                                    <view class="tit" :style="'color: ' + module.textColor + ';'" @click="changeCatNav" data-id="0" data-categoryid="0">{{
                                        $t("推荐")
                                    }}</view>
                                </view>
                                <view

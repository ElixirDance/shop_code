<template>
    ...
    >
        <view class="module-ad-content">
            <view class="banner">
                ...
                <view class="bar">
                    ...
                    <view class="search-top">
                        <view
                            ...
                            v-if="module.searchContent?.menuIcon"
                        >
                            <image
                                class="menu-icon"
                        ...
                        <view
                            ...
                            v-if="module.searchContent?.signIcon"
                        >
                            <image
                                class="sign-icon"
                    ...
                    <view class="search-word" :style="searchWordStyle" v-if="module.navContent?.showNav == 1">
                ...
                <view
                    ...
                    "
                >
                    <view :style="`padding-top: ${index == 0 ? saveHeight : 0}px`"></view>
                    <view class="circle" :style="circleStyle"></view>
                    <view class="search-top">
                        <view
                            class="menu"
        ...
        <template v-if="isOverseas()">
            <tig-select-lang ref="selectLangRef"> </tig-select-lang>
        </template>
    </view>
</template>

                        ...
                        <template v-if="module.picList">
                            <template v-if="module.picType == 5">
                                <view class="image-square-layout image-square-layout-height2">
                                    <view class="image-ad-item">
                                        ...
                                        >
                                            <imageBox :src="module.picList[0].picUrl"></imageBox>
                                        </view>
                                    </view>
                                    <view class="grid-layout-2">
                                        <view class="image-ad-item">
                                            <view
                                                ...
                                                :style="format.imgPadding"
                                            >
                                                <imageBox :src="module.picList[1].picUrl"></imageBox>
                                            </view>
                                        </view>
                                        <view class="image-ad-item">
                                            <view
                                            ...
                                            >
                                                <imageBox :src="module.picList[2].picUrl"></imageBox>
                                            </view>
                                        </view>
                                    </view>
                                </view>
                                        ...
                                        <view class="grid-layout-3">
                                            ...
                                            <view class="image-ad-item">
                                                <view
                                                    ...
                                                    :style="format.imgPadding"
                                                >
                                                    <imageBox :src="module.picList[3].picUrl"></imageBox>
                                                </view>
                                            </view>
                                        </view>
                                    </view>
                            ...
                            <template v-else>
                                <view :class="'image-square-layout-' + module.picType + ' image-square-layout-height1'">
                                    <view class="image-ad-item" v-for="(pic, key) in module.picList" :key="key">
                                        <view
                                            class="item-content"
                                            :style="format.imgPadding"
                                            @click="pic.picLink && redirect({ url: urlFormat(pic.picLink) })"
                                        >

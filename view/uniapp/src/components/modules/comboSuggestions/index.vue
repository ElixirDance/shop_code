                                ...
                                >
                                    <template v-slot:default="{ item }">
                                        <view class="pic-box" @click="urlFormat(item.picLink) && redirect({ url: urlFormat(item.picLink) })">
                                            <view class="pic-img" :style="` height: ${height}px;background-image: url(${imageFormat(item.picUrl)});`"></view>
                                    ...
                                    <template v-slot:default="{ item }">
                                        ...
                                        >
                                            ...
                                            <view class="goods-price" :style="`color: ${module.regularPriceColor}`">
                                                <format-price :showDecimals="false" :priceData="item.productPrice"></format-price>
                                            </view>
                                        </view>
                                    </template>
                                </tig-swiper>

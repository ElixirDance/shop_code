<template>
    ...
    >
        <view
            ...
            "
        >
            <view class="slidelarge-image" ref="slidelargeRef">
                <view :style="titleStyle.titleBox" v-if="module.moduleTitle && module.moduleTitle.titlePosition === 'top'">
                            ...
                            <template v-for="(item, index) in list" :key="index">
                                ...
                                >
                                    <view :style="itemStyle">
                                        <view :style="imgStyle + `background-image: url(${imageFormat(item.picUrl)});`"></view>
                                        <view
                                            :style="
                ...
                <view :style="titleStyle.titleBox" v-if="module.moduleTitle && module.moduleTitle.titlePosition === 'bottom'">

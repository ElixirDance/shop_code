                    ...
                    <template v-for="(group, index) in module.groupList" :key="group">
                        ...
                        >
                            <view class="bg_title" @click="urlFormat(group.titleLink) && redirect({ url: urlFormat(group.titleLink) })">
                                ...
                                <view
                                    class="p line1"
                                    :style="`color: ${module.moduleColor.subTitleColor}; font-size: ${module.moduleColor.subTitleSize}px`"
                                >
                                    {{ $t(group.subTitle) }}
                                </view>
                            </view>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <view class="goods-info" :style="`justify-content: center; padding: 0px 0px 0px 10px`">
                                                ...
                                                <view class="tag" v-if="module.showProductLabel && formatLabel(group.label)[itemIndex]">
                                                    <view
                                                        class="span"
                                                ...
                                                <view class="goods-price-box" :style="`margin-top: ${module.productPriceMarginTop}px`">
                                                    <view class="price-origin-sale">
                                                        <view class="price-origin-icon">
                                                            ...
                                                            >
                                                                <format-price
                                                                    :fontStyle="{ fontSize: '22rpx', 'text-decoration': 'line-through' }"

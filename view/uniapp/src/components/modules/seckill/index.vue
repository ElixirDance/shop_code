                                ...
                                <view class="item-con">
                                    <view class="item-photo">
                                        ...
                                        <view :class="'cap-seckill-goods__tag ' + className">
                                            <text class="cap-seckill-goods__tag-title" v-if="module?.style == 1"> {{ $t("秒杀") }} </text>
                                            <tig-countdown :endTime="item.seckkillData.seckillEndTime"></tig-countdown>
                                        </view>
                                    </view>
                                    <view class="item-info">
                                        ...
                                        <block v-if="module.showPrice">
                                            <view class="item-action">
                                                ...
                                                <view class="item-buy">
                                                    <view @click="buy(item.productId)" :data-id="item.productId" class="buy-btn">

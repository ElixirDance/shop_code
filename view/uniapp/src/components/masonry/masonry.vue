            ...
            <template v-for="item in leftList" :key="item.id">
                <slot name="left" :item="item">
                    <view class="item-li" @click="toPage(item)">
                        <view class="photo">
                            <tig-lazy-image :src="item.picThumb" mode="widthFix"></tig-lazy-image>
                        ...
                        <view class="info">
                            ...
                            <view class="flex activity-box" v-if="Object.keys(promotionList).length > 0">
                            ...
                            <view class="action">
                                ...
                                <view class="buy_btn" @click.stop="handleBuy(item)">
                                    <template v-if="item.isCheck">
                                        <up-loading-icon size="22" mode="circle"></up-loading-icon>
                                    </template>
                                    <template v-else>
                                        <template v-if="type === 'exchange'">
                            ...
                            <template v-if="item.shop && isMerchant()">
                                <view class="shop" @click.stop="handleToShop(item.shop.shopId)">
                                    ...
                                    <view class="shop-btn">{{ $t("进店") }} <text class="iconfont-h5 icon-youjiantou"></text></view>
                                </view>
                            </template>
                        </view>
                    </view>
